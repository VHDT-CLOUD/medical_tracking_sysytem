...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--password', type=str, required=True, help='Password for the hospital account')
    ...
    def handle(self, *args, **options):
        try:
            ...
            self.stdout.write(self.style.SUCCESS(
                f"Successfully added hospital: {options['name']} with ID: {hospital.hospital_id}\n"
                f"Login with:\n"
                f"Registration Number: {options['registration_number']}\n"
